  ...
  <div className="bg-white rounded-full p-3 sm:p-4 shadow-lg">
    ...
    />
              ...
              <div className="flex gap-2 justify-center mt-6 sm:mt-8">
                <div className={`w-2 h-2 rounded-full transition-all ${authMode === 'login' ? 'bg-white w-8' : 'bg-white bg-opacity-50'}`}></div>
                <div className={`w-2 h-2 rounded-full transition-all ${authMode === 'register' ? 'bg-white w-8' : 'bg-white bg-opacity-50'}`}></div>
              </div>
            </div>
          </div>
            ...
            <div className="w-full max-w-md">
              ...
              <div className="space-y-4 sm:space-y-5">
                {authMode === 'register' && (
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2.5 sm:px-4 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all outline-none text-sm sm:text-base"
                    />
                  </div>
                )}
                ...
                <button
                  onClick={handleAuth}
                  disabled={loading}
                  className="w-full bg-gradient-to-r from-emerald-600 to-emerald-700 text-white py-2.5 sm:py-3 rounded-lg font-semibold hover:from-emerald-700 hover:to-emerald-800 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-emerald-200 text-sm sm:text-base"
                >
