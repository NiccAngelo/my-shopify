...
export function OrderCard({ order, onStatusUpdate, isSelected, onSelect }) {
  ...
  return (
    <div className={`bg-white/80 backdrop-blur rounded-xl border ${isSelected ? 'border-green-400 ring-2 ring-green-200' : 'border-green-100'} shadow-sm hover:shadow-lg transition-all duration-300`}>
      <div className="p-5">
        ...
        <div className="flex items-start gap-3">
          ...
          <input
            ...
            className="mt-1.5 w-5 h-5 text-green-600 border-gray-300 rounded focus:ring-green-500 cursor-pointer"
          />
          
          {/* Wrapped existing content in flex-1 div */}
